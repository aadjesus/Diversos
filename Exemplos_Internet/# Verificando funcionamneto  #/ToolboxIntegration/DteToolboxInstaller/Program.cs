...
namespace ComponentOwl.ToolboxIntegration
{
    ...
    public class Program
    {
        ...
        public static int Main(string[] args)
        {
            ...
            ExitCode exitCode;
            DteToolboxInstaller toolboxInstaller = null;
            ...
            try
            {
                ...
                toolboxInstaller = new DteToolboxInstaller(assemblyPath, tabName);

                exitCode = (modeInstall
                                ? toolboxInstaller.InstallControls(null,version)
            ...
            {
                if (toolboxInstaller != null)
                {
                    toolboxInstaller.Dispose();
                }
            }
