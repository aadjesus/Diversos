...
namespace System.ComponentModel.Composition
{
    ...
    internal static partial class ExportServices
    {
        ...
        internal static Func<Export, object> CreateStronglyTypedExportFactoryFactory(Type exportType, Type metadataType)
        {
            MethodInfo genericMethod = null;
            ...
            Assumes.NotNull(genericMethod);
            Func<Export, object> exportFactoryFactory = (Func<Export, object>)Delegate.CreateDelegate(typeof(Func<Export, object>), genericMethod);
