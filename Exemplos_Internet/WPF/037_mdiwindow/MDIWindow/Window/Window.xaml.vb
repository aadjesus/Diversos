...
#End Region
    ...
    Private Sub Window_SizeChanged(ByVal sender As Object, ByVal e As System.Windows.SizeChangedEventArgs) Handles Me.SizeChanged
        If Me.ActualHeight < 29 OrElse Me.ActualWidth = 0 Then
            Return
        End If
        ContentContainer.Height = Me.ActualHeight - TopBar.ActualHeight
        'ContentBorder.Height = Me.ActualHeight - TopBar.ActualHeight
        ContentContainer.Width = Me.ActualWidth
        'ContentBorder.Width = Me.ActualWidth

        'ContentCanvas.Height = ContentContainer.ActualHeight
        'ContentCanvas.Width = ContentContainer.ActualWidth
    End Sub
