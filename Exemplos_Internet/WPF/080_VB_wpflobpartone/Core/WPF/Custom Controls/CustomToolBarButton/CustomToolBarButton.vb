...
#Region " Properties "
        ...
        <Category("Custom"), Description("This sets the position of the text in relation to the button image.")> _
        ...
        <Category("Custom"), Description("Image to display when the button is disabled.")> _
        ...
        <Category("Custom"), Description("Image to display when the button is enabled.")> _
