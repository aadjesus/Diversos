        ...
        If e.Y > TopMargin + BarHeight - 10 And e.Y < TopMargin + BarHeight + 20 And e.X > 5 And e.X < Me.Width - 5 Then
            ...
            Else
                ...
                Else
                    ...
                    If e.Button = Windows.Forms.MouseButtons.Left Then
                        ClearCurrPointer()
                        MiddlePointers.Add(New cblPointer(((e.X - 10) / (Me.Width - 20)), _
...
#Region "Drawing"
    ...
    Private Sub BuildABlend()
        ...
        TheShape.ColorFillBlend = New cBlendItems(BlendColors, BlendPositions)
    End Sub
...
#Region "Painting"
    ...
    Protected Overrides Sub OnPaint(ByVal e As System.Windows.Forms.PaintEventArgs)
        ...
        If TheShape.FillType = Shape.eFillType.GradientPath Then
            TheShape.Refresh()
        End If
