...
namespace Test
{
    ...
    namespace Items
    {
        ...
        public class SimpleItem_FullTc : SimpleItem
        {
            ...
            public SimpleItem_FullTc()
                : base(-1, "SimpleItem FullTC")
            { }

            public SimpleItem_FullTc(int Id, string Name)
                : base(Id, Name)
            {
            }
        }
        ...
        public class SimpleItem_BasicTc : SimpleItem
        {
            ...
            public SimpleItem_BasicTc()
                : base(-1, "SimpleItem BasicTC")
            { }
        ...
        public class SimpleItem_Component : SimpleItem, IComponent
        {
            ...
            public SimpleItem_Component()
                : base(-1, "SimpleItem Comp")
            {
        ...
        public class ComplexItem : SimpleItem, ISupportUniqueName
        {
            ...
            public ComplexItem(int Id, string Name, ComplexItem[] complexItems)
                : base(Id, Name)
            {
    ...
    namespace CollectionEditors
    {
        ...
        public class SimpleItem_CollectionEditor : System.ComponentModel.Design.CollectionEditor
        {
            ...
            public SimpleItem_CollectionEditor(Type type)
                : base(type)
            {
