...
<script runat="server">
    ...
    Sub Page_Load()
        dim bChecked as boolean = CheckBox1.Checked
        GridView1.Visible = bChecked
        GridView2.Visible = not bChecked

        if not IsPostBack then
            dim t as System.Data.DataTable = DataProvider.CreateCategoryWithSubGroupsDataSource(5)
