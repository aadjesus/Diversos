...
namespace Elsehemy
{
    public class SuperToolTipInfo
    {
        ...
        {
            //colors
            _backgroundGradientBegin = Color.FromArgb(255, 250, 172);
            _backgroundGradientMiddle = Color.FromArgb(255, 207, 157);
            _backgroundGradientEnd = Color.FromArgb(255, 153, 0);

            //Default Body
            _bodyText = string.Empty;
            _bodyImage = null;
            _bodyTextForeColor = Color.Black;

            //Default Header
            _showHeader = false;
            _headerText = string.Empty;
            _headerTextForeColor = Color.Black;
            ...
            _footerImage = null;
            _footerTextForeColor = Color.Black;
            _footerImage = null;
