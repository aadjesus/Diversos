...
#Region "Property Variables"
    ...
    Friend bmenutext As String = ""
    Friend bhelpbutton As Boolean = False
    Friend bimageonly As Boolean = False
    Friend bimagelist As ImageList = Nothing
    Friend bEnabled As Boolean = True
    Friend bindex As Integer = 4
    Friend bicon As Bitmap = Nothing
#End Region
...
#Region "User32.dll"
    ...
    (ByVal hMenu As Int32, ByVal nPosition As Int32, _
 ...
 ByVal wIDNewItem As Int32, _
  ByVal lpNewItem As String) As Int32
    ...
    Friend Declare Function GetSystemMenu Lib "user32" Alias "GetSystemMenu" _
       (ByVal hwnd As IntPtr, ByVal bRevert As Int32) As Int32
    ...
    <DllImport("user32")> _
    Friend Shared Function GetWindowDC(ByVal hwnd As Integer) As Integer
    End Function

    <DllImport("user32")> _
    Friend Shared Function GetAsyncKeyState(ByVal vKey As Integer) As Short
    End Function


    <DllImport("user32")> _
    Friend Shared Function SetCapture(ByVal hwnd As Integer) As Integer
    End Function
    ...
    <DllImport("user32")> _
    Friend Shared Function GetSysColor(ByVal nIndex As Integer) As Integer
    End Function
...
Friend Shared Function openThemeData(ByVal hWnd As IntPtr, ByVal classList As String) As IntPtr
    ...
    Friend Shared Function closeThemeData(ByVal hTheme As IntPtr) As <MarshalAs(UnmanagedType.Error)> Int32
    End Function
...
#Region "Constructor and Handle-Handler ^^"
    ...
    Public Sub StateChange(ByVal sender As Object, ByVal s As state)
        DrawButton()
    End Sub

    Public Sub Helpbtnclicked(ByVal sender As Object, ByVal e As EventArgs)
        If bhelpbutton Then
        ...
        Select Case parent.FormBorderStyle
            Case FormBorderStyle.SizableToolWindow, FormBorderStyle.FixedToolWindow
                ...
                ElseIf bimageonly = False Then
                    Select Case state
                        ...
                        Case state.Pushed
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 3, New RECT(New Rectangle(pos.X, pos.Y, btn_width / 1.5, btn_height / 1.5)), IntPtr.Zero)
                        Case state.Disabled
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 4, New RECT(New Rectangle(pos.X, pos.Y, btn_width / 1.5, btn_height / 1.5)), IntPtr.Zero)
                    End Select
                End If
            ...
            Case Else
                ...
                If bhelpbutton = True Then
                    Select Case state
                        Case state.Normal
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 23, 1, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Hot
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 23, 2, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Pushed
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 23, 3, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Disabled
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 23, 4, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                    End Select
                ElseIf bimageonly = False Then
                    Select Case state
                        Case state.Normal
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 1, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Hot
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 2, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Pushed
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 3, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                        Case state.Disabled
                            drawThemeBackground(openThemeData(Me.Handle, "Window"), g.GetHdc, 15, 4, New RECT(New Rectangle(pos.X, pos.Y, btn_width, btn_height)), IntPtr.Zero)
                    End Select
                End If
                g = Graphics.FromHdc(New IntPtr(GetWindowDC(parent.Handle.ToInt32)))  'm.HWnd));
                If bhelpbutton = False Then
...
#Region "SetState"
    Public Function SetState(ByVal newstate As state)
        sstate = newstate
        RaiseEvent MinTrayBtnStateChanged(Me, sstate)
    End Function
#End Region
