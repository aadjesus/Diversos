...
#define UWM_LABEL_KEYPRESSED	WM_USER+15
/////////////////////////////////////////////////////////////////////////////
// CLabel window
...
public:
	...
	virtual CLabel& SetBevelLine(BOOL bBevelline);
	virtual void SetTransparentBk(COLORREF Col, BOOL bTransparentPic);
...
public:
	...
	CButton* GetBuddy(void);
	BOOL IsBuddy(void);
	void SetBuddy(CButton* pByddyButton);
