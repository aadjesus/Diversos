...
#define HDN_ITEMRCLICK		(WM_APP + 10003)
#define WM_BUTTON_LCLICKED	(WM_APP + 10004)
...
// Edit styles. by Arf
#define RC_EDIT_CTRL			0 // Edit Control
#define RC_COMBO_CTRL			1 // ComboBox
#define RC_BUTTON_CTRL			2 // ButtonCtrl

//Ctrl ids. by Arf
#define ID_BUTTON				15050
...
public:		
	...
	void EnableHdrRClick(BOOL bEnable)
	{
		m_bEnableHdrRClick = bEnable;
	};

	BOOL SetColumnEditable(UINT column,BOOL bEditable = TRUE)
	{
		if (column >= m_bEditableColumn.size())
			return FALSE;
		m_bEditableColumn[column]=bEditable;
		return TRUE;
	};
	///////////////////////////////////////////////////////////////////////
	//		Images & Color
	...
	// Other //By Arf
	int FindSubItem(CString str,int nCol);
	///////////////////////////////////////////////////////////////////////
...
protected:	
	...
	DWORD _GetHeaderTextEditFormat(int nColumn) const;
	...
	// Member data	
	CString m_strBtnCaption;
	CEdit* m_pWndEdit; // Edit control, for subitem edit
	CComboBox* m_pWndCombo; // Combo box, for subitem edit by Arf
	CButton* m_pWndButton;  // Button for subitem edit by Arf
	...
	BOOL m_bEnableHdrRClick;
	vector <BOOL>	 m_bLockColumn;
	vector <BOOL>	 m_bEditableColumn;
	vector <int>	 m_ColumnEditStyle;
	vector <CString> m_comboStrings;
	//////////////////////////////////////////////////////////////////////
...
protected:	
	...
	afx_msg void OnKillFocusChild();
	afx_msg void OnBnClickedButton();

public:
	void SetComboStrings(vector <CString> comboStrings)
	{
		m_comboStrings = comboStrings;

	}

	void SetButtonCaption(CString strBtnCaption)
	{
		m_strBtnCaption = strBtnCaption;
	}

	void SetColoumnEditStyle(UINT nCol,int style)
	{
		if (m_ColumnEditStyle.size() < nCol)
			return;

		m_ColumnEditStyle[nCol] = style;
	}
