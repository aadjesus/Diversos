...
namespace LJ.Controls.Win32
{
	...
	#region Drive Type
	public enum DriveTypeRaw
	{
		// I call this enumeration
		// DriveTypeRaw because I provide another
		// enumeration to be use in the Class DriveComboBox
		// that provides friendlier enumeration values which
		// can also be easily converted to friendly strings
		// This one is to be used with the Windows API
		DRIVE_UNKNOWN     = 0,
		DRIVE_NO_ROOT_DIR = 1,
		DRIVE_REMOVABLE   = 2,
		DRIVE_FIXED       = 3,
	...
	public enum ImageListDrawColors : uint
	{
		CLR_NONE		= 0xFFFFFFFF,
