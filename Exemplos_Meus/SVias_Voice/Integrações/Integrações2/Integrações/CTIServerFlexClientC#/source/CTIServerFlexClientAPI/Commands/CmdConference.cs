...
{
    public class CmdConference : CmdDevCalBase
    {
        ...
        public String CallIdTo
        {
            get { return protocol.Get(DataProtocol.DATA_TYPE_SIMPLE.CTO).ToString(); }
            set { protocol.Replace(DataProtocol.DATA_TYPE_SIMPLE.CTO, value); }
        }
        override public void FillProtocol()
        {
            protocol.Replace(DataProtocol.DATA_TYPE_SIMPLE.CTP, 15);
	    }
    }
}
