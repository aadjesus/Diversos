...
public class CTIFlexAPITesteApplet extends JApplet implements FlexStreamListener, CollectionListener {
	/**
	 * This is the default constructor
	 */
	public CTIFlexAPITesteApplet() {
		super();
	}
	/**
	...
	private JTextField getTxtURL() {
		if (txtURL == null) {
			...
			txtURL.setText(getParameter("URL"));
	...
	private JTextField getTxtDevice() {
		if (txtDevice == null) {
			...
			String dev = getParameter("device");
			if (dev == null)
				dev = "1000";
