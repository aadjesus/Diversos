...
{
    public partial class SmartViewer : MasterForm
    {
        #region Contrutor
        ...
        private void trLstSmartViewer_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (dataRowView != null)
            {
                ...
                if (Convert.ToInt32(dataRowView["Imagem"]).Equals(0))
                {
                    ...
                    (dataRowView["Arquivo"] as Assembly).GetTypes()
                        ...
                        .ForEach(f =>
                        {
                            try
                            {
                                MasterPanelBrowseDePesquisa masterPanelBrowseDePesquisa = Activator.CreateInstance(f) as MasterPanelBrowseDePesquisa;
        ...
        private void tlTpCtrlrSmartViewer_GetActiveObjectInfo(object sender, DevExpress.Utils.ToolTipControllerGetActiveObjectInfoEventArgs e)
        {
                ...
                if (treeListHitInfo.HitInfoType == HitInfoType.Cell)
                {
                    ...
                    if (dataRowView != null)
                        e.Info = new DevExpress.Utils.ToolTipControlInfo(
                            ...
                            this.rpstryItmImgCmbBxImagemDescricao.Items.GetItem(dataRowView["Imagem"]).Description);
                }
            }
        }

        private void trLstSmartViewer_GetCustomSummaryValue(object sender, GetCustomSummaryValueEventArgs e)
        {
            if (e.IsSummaryFooter)
                e.CustomValue = Enumerable
                    .Range(0, 7)
                    .Aggregate(String.Empty, (a, b) => String.Concat(
                        a, (String.IsNullOrEmpty(a) ? "" : " | "),
                        b, ": ",
                        this.dtTblTblTreeList.Rows
                            .OfType<DataRow>()
                            .Where(w => Convert.ToInt32(w["Imagem"]).Equals(b))
                            .Count()));
        ...
        private void ConsultarPesquisaDisponiveis()
        {
            ...
            FGlobus.Util.Util.RetornarDllsDoWPF("Pesquisa")
                .ToList()
                .ForEach(f =>
                {
                    ...
                    DataRow dataRow = this.dtTblTblTreeList.NewRow();
                    dataRow["Arquivo"] = assembly;
                    dataRow["Titulo"] = assembly.GetCustomAttributes(typeof(AssemblyTitleAttribute), true)
