...
namespace AvalonApplication3
{
    ...
    public class Window2 : Window
    {
        ...
        public Window2()
        {
            ...
            this.Content = InitializePostItNote();
            //this.Top = 0;
            //this.Left = 0;
        ...
        private StackPanel InitializePostItNote()
        {
            ...
            bi.BeginInit();
            System.Resources.ResourceManager rm = new System.Resources.ResourceManager("AvalonApplication3.Images",
            System.Reflection.Assembly.GetExecutingAssembly());
            System.Drawing.Bitmap b = rm.GetObject("alarm") as System.Drawing.Bitmap;
    ...
    //        simpleImage.Stretch = Stretch.None;
        ...
        void dialog_Closed(object sender, EventArgs e)
        {
            ...
            if (dia.Tag != null)
            {
                ...
                if (arr[1] != null)
                {
                    ...
                    //rtb.Foreground = Dialog.colorArrayForeground[_windowForeground];
                }
                else
                {
        ...
        {
            Menu m = ((Menu)(((MenuItem)(((MenuItem)(sender as MenuItem)).Parent as MenuItem)).Parent as Menu));
           // Window2 w = ((Window2)(((StackPanel)(m.Parent as StackPanel)).Parent as Window));
            Window2 w = ((Window2)(((StackPanel)((WrapPanel)(m.Parent as WrapPanel)).Parent as StackPanel).Parent as Window));
            if (w.Topmost == false)
            {
                w.Topmost = true;
        ...
        {
            Menu m = ((Menu)(((MenuItem)(((MenuItem)(sender as MenuItem)).Parent as MenuItem)).Parent as Menu));
            //((Window2)(((StackPanel)(m.Parent as StackPanel)).Parent as Window2)).Close();
